        ...
        options =
          ...
          // lib.optionalAttrs forNixos {
            user = mkOption {
              ...
              default = null;
              description = ''
                The user account to run the systemd service as.

                If not provided, it will use the common setting (watgbridge)
              '';
            };
            ...
            group = mkOption {
              ...
              default = null;
              description = ''
                The group account to run the systemd service as.
